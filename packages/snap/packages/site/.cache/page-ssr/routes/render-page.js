...
let MetamaskActions = /*#__PURE__*/function (MetamaskActions) {
  MetamaskActions["SetInstalled"] = "SetInstalled";
  MetamaskActions["SetSnapsDetected"] = "SetSnapsDetected";
  MetamaskActions["SetError"] = "SetError";
  MetamaskActions["SetIsFlask"] = "SetIsFlask";
  return MetamaskActions;
}({});
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const setSnapsCompatibility = async () => {
      dispatch({
        ...
        payload: await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.detectSnaps)()
      });
    };
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    async function detectSnapInstalled() {
      dispatch({
        ...
        payload: await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.getSnap)()
      });
    }
    const checkIfFlask = async () => {
      dispatch({
        type: MetamaskActions.SetIsFlask,
        payload: await (0,_utils__WEBPACK_IMPORTED_MODULE_1__.isFlask)()
      });
    };
...
/* harmony export */   detectSnaps: () => (/* reexport safe */ _metamask__WEBPACK_IMPORTED_MODULE_0__.detectSnaps),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   detectSnaps: () => (/* binding */ detectSnaps),
...
const detectSnaps = async () => {
  ...
  if ((_window$ethereum = window.ethereum) !== null && _window$ethereum !== void 0 && _window$ethereum.detected) {
    for (const provider of window.ethereum.detected) {
      try {
        ...
        await (0,_snap__WEBPACK_IMPORTED_MODULE_0__.getSnaps)(provider);
  ...
  try {
    await (0,_snap__WEBPACK_IMPORTED_MODULE_0__.getSnaps)();
    return true;
  } catch {
    return false;
  }
 ...
 */
const getSnaps = async provider => await (provider !== null && provider !== void 0 ? provider : window.ethereum).request({
...
/***/ "react-dom/server":
/*!**********************************************************************************************************!*\
  !*** external "/Users/auralshin/Adrasteia/packages/snap/packages/site/node_modules/react-dom/server.js" ***!
  \**********************************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/auralshin/Adrasteia/packages/snap/packages/site/node_modules/react-dom/server.js");

/***/ }),

/***/ "react":
/*!*****************************************************************************************************!*\
  !*** external "/Users/auralshin/Adrasteia/packages/snap/packages/site/node_modules/react/index.js" ***!
  \*****************************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/auralshin/Adrasteia/packages/snap/packages/site/node_modules/react/index.js");
