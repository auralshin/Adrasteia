...
const Index = () => {
  const {
    0: state,
    1: dispatch
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_hooks__WEBPACK_IMPORTED_MODULE_3__.MetaMaskContext);
  const isMetaMaskReady = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.isLocalSnap)(_config__WEBPACK_IMPORTED_MODULE_2__.defaultSnapOrigin) ? state.isFlask : state.snapsDetected;
  const handleConnectClick = async () => {
    try {
      await (0,_utils__WEBPACK_IMPORTED_MODULE_4__.connectSnap)();
      const installedSnap = await (0,_utils__WEBPACK_IMPORTED_MODULE_4__.getSnap)();
      dispatch({
        type: _hooks__WEBPACK_IMPORTED_MODULE_3__.MetamaskActions.SetInstalled,
        payload: installedSnap
      });
    } catch (error) {
      console.error(error);
      dispatch({
        type: _hooks__WEBPACK_IMPORTED_MODULE_3__.MetamaskActions.SetError,
        payload: error
      });
    }
  };
  const handleSendHelloClick = async () => {
    try {
      await (0,_utils__WEBPACK_IMPORTED_MODULE_4__.sendHello)();
    } catch (error) {
      console.error(error);
      dispatch({
        type: _hooks__WEBPACK_IMPORTED_MODULE_3__.MetamaskActions.SetError,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Container, {
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(Subtitle, {
      children: ["Get started by editing ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("code", {
        children: "src/index.ts"
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(CardContainer, {
      children: [state.error && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(ErrorMessage, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("b", {
          children: "An error happened:"
        }), " ", state.error.message]
      }), !isMetaMaskReady && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components__WEBPACK_IMPORTED_MODULE_1__.Card, {
        content: {
          title: 'Install',
        ...
        fullWidth: true
      }), !state.installedSnap && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components__WEBPACK_IMPORTED_MODULE_1__.Card, {
        content: {
          title: 'Connect',
        ...
        disabled: !isMetaMaskReady
      }), (0,_utils__WEBPACK_IMPORTED_MODULE_4__.shouldDisplayReconnectButton)(state.installedSnap) && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components__WEBPACK_IMPORTED_MODULE_1__.Card, {
        content: {
          title: 'Reconnect',
        ...
        disabled: !state.installedSnap,
        fullWidth: isMetaMaskReady && Boolean(state.installedSnap) && !(0,_utils__WEBPACK_IMPORTED_MODULE_4__.shouldDisplayReconnectButton)(state.installedSnap)
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Notice, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("p", {
          children: ["Please note that the ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("b", {
            children: "snap.manifest.json"
          }), " and", ' ', /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("b", {
